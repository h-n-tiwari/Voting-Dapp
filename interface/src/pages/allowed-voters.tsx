                ...
                <div {...getRootProps()}>
                  ...
                  <div className="voter_container_box_div_info">
                    <p className="leading-[5]">
                      Upload File: PNG, JPG, GIF, WEBM, WEBP Max 20MB
                    </p>
...
//             <div className="bg-[#231E39] rounded-[25px] p-6 shadow-[10px_10px_15px_rgba(0,0,0,0.35)] text-[#b3b8cd]">
//               <h4> Create candidate For Voting </h4>
//               <p>
//                 {" "}
//                 Blockchain voting organization, provide ethereum ecosystem{" "}
//               </p>
//               <p className="text-[#9a02ac] font-medium mt-2"> Contract Candidate </p>
//             </div>
//             <div className="flex flex-col gap-4 mt-4">
//               {/*{voterArray.map((el, index) => (
//                 <div key={index + 1} className="flex items-center gap-4 bg-[#231E39] rounded-[15px] p-4">
//                   <div className="w-12 h-12 rounded-full overflow-hidden">
//                     <Image src="" alt="Voter Image" />
//                   </div>
//                   <div className="flex flex-col gap-1 text-[#b3b8cd] text-sm">
//                     <p>Name</p>
//                     <p>Address</p>
//                     <p>Position</p>
//                   </div>
...
//                 <div {...getRootProps()}>
//                   <input {...getInputProps()} />
//                   <div className="flex flex-col items-center text-center text-[#b3b8cd] gap-2">
//                     <p className="leading-[5]">
//                       Upload File: PNG, JPG, GIF, WEBM, WEBP Max 20MB
//                     </p>
...
//         <div className="flex flex-col items-center gap-4 text-center bg-[#231E39] rounded-[25px] p-8 shadow-[10px_10px_15px_rgba(0,0,0,0.35)] text-[#b3b8cd]">
//           <Image
//             src={Images.CREATOR}
//             alt="user Profile"
//             width={150}
